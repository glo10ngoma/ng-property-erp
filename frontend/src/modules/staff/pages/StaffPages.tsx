...
export function EmployeesPage() {
  ...
  const jobOptions = uniqueValues(employees.data.map((row) => row.job_title));
  ...
  return <section>
    ...
    {createOpen && <EmployeeModal title="Nouvel employé" onClose={() => setCreateOpen(false)} onSubmit={(form) => saveEmployee(form, null)} />}
    {editing && <EmployeeModal title="Modifier employé" employee={editing} onClose={() => setEditing(null)} onSubmit={(form) => saveEmployee(form, editing)} />}
  ...
  return <section>
    ...
    <Section title="Identité">
      <div className="detail-list">
        ...
        <span>Date naissance</span><strong>{detail.birth_date ? shortDate(detail.birth_date) : '—'}</strong>
...
function EmployeeModal({ title, employee, onClose, onSubmit }: { title: string; employee?: Employee | null; onClose: () => void; onSubmit: (form: FormData) => void }) {
