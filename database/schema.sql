...
CREATE TABLE tenants (
  id SERIAL PRIMARY KEY,
  tenant_type VARCHAR(20) NOT NULL DEFAULT 'PHYSICAL',
  ...
  business_sector VARCHAR(140),
  legal_representative_name VARCHAR(180),
  legal_representative_role VARCHAR(120),
  legal_representative_phone VARCHAR(60),
  legal_representative_email VARCHAR(160),
  company_document_name VARCHAR(220),
