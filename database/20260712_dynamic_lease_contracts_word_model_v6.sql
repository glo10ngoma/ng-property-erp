...
ENTRE : société {{LANDLORD_NAME}}, immatriculée au Registre du commerce et du Crédit Mobilier de Kinshasa sous le numéro {{LANDLORD_RCCM}} (RCCM), enregistrée à l’indentification Nationale au {{LANDLORD_NATIONAL_ID}}, dont le siège social est établi à {{LANDLORD_ADDRESS}}, représentée par son {{LANDLORD_REPRESENTATIVE_TITLE}}, Monsieur {{LANDLORD_REPRESENTATIVE}}. Ci-après dénommée Le Bailleur d’une part ;
...
a) S’agissant de la durée, le présent contrat de bail est conclus pour une durée de {{LEASE_DURATION_TEXT}} et entre en vigueur à la date de sa signature. Il est renouvelable avec l’accord du bailleur par écrit. Chacune des deux parties peut y mettre fin moyennant un préavis de {{NOTICE_MONTHS}} mois ou par convention mutuelle. Dans ce cas, la partie qui prend l’initiative de mettre fin au contrat devra notifier à l’autre son intention écrite, transmise par la lettre recommandée ou par lettre avec accusé de réceptions sous peine d’indemnités pour rupture abusive.

b) Le loyer mensuel du local est constitué de {{MONTHLY_TOTAL}} {{CURRENCY}} le mois dont :

{{RENT_BREAKDOWN}}

c) Le loyer ainsi convenu comprend l’entretien des parties communes, les factures d’eau et d’électricité, les caméras de surveillance et tout autre espace en commun à l’exclusion des services d’entretien des climatiseurs ou de réparation de tout autre accessoire.

d) Les parties conviennent que le loyer pourra être revu par la Direction du bailleur eu égard aux fluctuations économique liées aux réalités du marché immobilier.

Article 03 : DE LA GARANTIE LOCATIVE ET PREMIER PAIEMENT

a) La garantie locative équivaut à {{GUARANTEE_MONTHS}} mois (= {{MONTHLY_TOTAL_RAW}} x {{GUARANTEE_MONTHS}})

b) Le preneur est tenu de verser la totalité de la garantie au bailleur à la signature du présent contrat moyennant quittance.

c) La garantie locative n’est pas productive d’intérêt, elle est remboursable à la fin du bail après déduction faite de toutes sommes dues au bailleur à quelque titre que ce soit.

d) Le preneur a l’obligation de payer le loyer sans référence aucune à la garantie locative.
...
a) Il a interdit au preneur de céder en tout ou en partie du présent contrat ni de sous-louer tout ou une partie des biens loués à un tiers.

b) Il est interdit au preneur de modifier tout ou une partie des biens loués, ni même d’enforcer un clou dans le mur sauf autorisation écrite préalable du bailleur.

Article 06 : DE L’ENTRETIEN ET DE NOMBRE D’0CCUPANTS

1. Le Preneur tiendra les lieux loués, leurs aménagements et leurs accessoires en bon état d’entretien, de fonctionnement, de propriété et de réparation locative et jouira du bien loué en bon père de famille ;

2. En cas de besoin, le tenant devra procéder au remplacement des accessoires électriques (ampoules, prises, sockets, interrupteur, et de plomberie (robinets) et ce, sous le contrôle et la surveillance du bailleur durant toute la période de bail.

3. Il laissera visiter les lieux à tout moment par le Bailleur ou son représentant et ce, aux époques que celui-ci jugera convenablement à condition d’en prévenir le Preneur deux jours à l’avance et le preneur ne pourra s’opposer à cette visite.

4. Pour occuper un (1) appartement de {{BEDROOM_COUNT_TEXT}} chambres, il n’est autorisé qu’une seule famille. Pour des cas d’occupation individuelle, 2 à 3 personnes célibataires peuvent partager un même appartement.

5. Un parking est ordinairement réservé à chaque appartement.
...
a) En cas de non-respect de l’une des clauses, le bailleur peut résilier le contrat de bail moyennant un préavis de {{NOTICE_MONTHS}} mois ;

b) Si l’une des dispositions n’a pas été prise en compte dans le présent contrat, les parties conviennent de se référer à la loi n° 15/025 du 31 décembre 2015 relative aux baux à loyer non professionnels.

c) En cas d’abus grave, le bailleur a le droit de résilier le contrat avec un effet immédiat.

Article 10 : DE LA MODIFICATION DU CONTRAT

Toute modification du présent contrat de bail fera l’objectif d’un avenant signé par les deux parties et sera annexé au présent Contrat de bail.
...
Tous les litiges entre les parties seront règles a l’amiable, a défauts seuls les Cours et Tribunaux de Kinshasa sont compétents pour leurs résolutions.

Ainsi, fait à Kinshasa en deux exemplaires, les parties reconnaissent le sein en date de signature.

Fait à {{SIGNATURE_PLACE}}, le {{SIGNATURE_DATE}}
