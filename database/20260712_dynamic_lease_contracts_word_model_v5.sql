...
SELECT
  organization_id,
  'Contrat de bail a usage residentiel - modele Word v5',
  'LEASE_RESIDENTIAL',
  5,
  'RESIDENTIAL',
...
Précisions
Appartement {{APARTMENT_LABEL}} | {{UNIT_NUMBER}}
...
S’agissant de la durée, le présent contrat de bail est conclu pour une durée d’une année et entre en vigueur à la date de sa signature. Il est renouvelable avec l’accord du bailleur par écrit. Chacune des deux parties peut y mettre fin moyennant un préavis de 3 mois ou par convention mutuelle. Dans ce cas, la partie qui prend l’initiative de mettre fin au contrat devra notifier à l’autre son intention écrite, transmise par lettre recommandée ou par lettre avec accusé de réception sous peine d’indemnités pour rupture abusive.
...
Les parties conviennent que le loyer pourra être revu par la Direction du bailleur eu égard aux fluctuations économiques liées aux réalités du marché immobilier.
...
Soit un montant total de {{GUARANTEE_TOTAL}} USD.
...
Article 06 : DE L’ENTRETIEN ET DU NOMBRE D’OCCUPANTS
...
En cas de besoin, le preneur devra procéder au remplacement des accessoires électriques (ampoules, prises, sockets, interrupteur) et de plomberie (robinets), et ce, sous le contrôle et la surveillance du bailleur durant toute la période de bail.
...
A la fin du bail, après constat de l’état des lieux, le preneur est tenu de remettre l’appartement dans l’état où il avait pris. En espèce, le Bailleur devra rafraîchir les murs des lieux loués ainsi que la réparation de tous dégâts que pourra subir l’appartement du fait du preneur aux frais exclusifs du preneur.
A défaut, le bailleur sera obligé de retenir automatiquement les frais y relatifs après expertise et évaluation du coût des travaux sur la garantie locative même sans l’accord préalable du preneur. La fin du bail ne sera effective que par la remise par le preneur au bailleur de toutes les clés de l’appartement occupé.
