...
ALTER TABLE public.bank_transactions
  ...
  CHECK (transaction_type IN ('OPENING_BALANCE', 'MANUAL_ADJUSTMENT', 'RENT_PAYMENT', 'GUARANTEE_PAYMENT', 'GUARANTEE_REFUND', 'TENANT_CREDIT', 'SHAREHOLDER_PAYOUT', 'BANK_EXPENSE'));
